...
namespace AssessmentApp
{
    internal class Cursor
    {
        ...
        public void MoveCursor(IEnumerable<int> argument)
        {
            int newX;
            int newY;
            Pen pen = new Pen(;

            graphics.DrawRectangle(Pen, newX, newY, DeafultWidth, DeafultHeight);
        }

        public void ChangeColor(Color commandColor)
        {
            DeafultColour = commandColor;
        }
